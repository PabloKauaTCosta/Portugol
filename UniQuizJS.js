    ...
    <script>
        ...
        const dadosQuiz = {
            ...
            geografia: [
                ...
                {
                    pergunta: "Qual é o país com maior população no mundo?",
                    opcoes: ["Índia", "China", "Estados Unidos", "Indonésia"],
                    resposta: "Índia"
                },
                {
                    pergunta: " Qual a linha imaginária que atravessa o Brasil?",
                    opcoes: ["Equador", "Círculo Polar Ártico", "Trópico de Cancêr", "Greenwich"],
                    resposta: "Equador"
                },
                {
                    pergunta: "Qual o oceano que banha o Brasil?",
                    opcoes: ["Pacífico", "Índico", "Atlântico", "Ártico"],
                    resposta: "Atlântico"
                },
                {
                    pergunta: "Qual é o principal combustível fossil da 1 Revolução Industrial?",
                    opcoes: ["Óleo Diesel", "Petróleo", "Carvão Mineral", "Gás Natural"],
                    resposta: "Carvão Mineral"
                },
                {
                    pergunta: "Qual é o único continente com terra nos quatro hemisférios?",
                    opcoes: ["Europa", "Ásia", "Oceania", "África"],
                    resposta: "África"
                },
                {
                    pergunta: "Além da Turquia, qual outro país está presente em dois continentes?",
                    opcoes: ["Rússia", "China", "Japão", "Itália"],
                    resposta: "Rússia"
                },
                {
                    pergunta: "Qual é o movimento terrestre responsável pela ocorrência das estações do ano?",
            ...
            espaco: [
                {
                    pergunta: "Em que galáxia está o Sistema Solar?",
                    opcoes: ["Andrômeda", "Via Láctea", "Galáxia do Triângulo", "Galáxia de Sombrero"],
                    resposta: "Via Láctea"
                },
                {
                    pergunta: " Qual é o nome da teoria mais aceita em que marca o início do universo?",
                ...
                {
                    pergunta: "Por qual outro nome é conhecida a Nebulosa de Hélix?",
                    opcoes: ["Olho de Deus", "Pilares da criação", "Andrômeda", "Nebulosa de Órion"],
                    resposta: "Olho de Deus"
                },
                {
                    pergunta: " Qual desses corpos celestes é um satélite natural da Terra?",
                    opcoes: ["Sol", "Marte", "Lua", "Fobos"],
                    resposta: "Lua"
                },
               {
                    pergunta: "Qual o maior buraco negro já descoberto?",
                    opcoes: ["TON 618", "1E1740.7-2942", " Phoenix A", "S5 0014+81 "],
                    resposta: " Phoenix A"
                },
                {
                    pergunta: "Quantos planetas existem atualmente no Sistema Solar (segundo a classificação da IAU)?",
                    opcoes: ["10", "9", "7", "8 "],
                    resposta: "8"
                },
                {
                ...
                {
                    pergunta: "O que são os anos-luz?",
        ...
        function carregarPergunta() {
            ...
            if (indicePerguntaAtual < perguntasAtuais.length) {
                ...
                // Verifica se a propriedade da pergunta é 'pergunta' ou 'questao'
                const textoDaPergunta = pergunta.pergunta || pergunta.questao;
                textoPergunta.textContent = textoDaPergunta;
